...
def _execute_case(
    ...
    _run_record_vcr(tap_source_dir, tap_test_dir, testcase, test_suite, python_exe, mode)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    record_parser = subparsers.add_parser("record", help="Record VCR cassette (live API)")
